    ...
    <section class="min-h-screen bg-[#fbfbfb] flex items-center justify-center">
        <div class="sm:w-3/4 lg:w-1/3 p-8 rounded-xl">
            <div class="flex flex-col items-center justify-center gap-2 mb-10">
                ...
                <span class="font-bold text-2xl">Войдите в свой аккаунт</span>
            </div>
            <div class="mx-auto max-w-md w-full">
                <form action="{{ route('auth.login') }}" method="POST" class="space-y-3 px-12" autocomplete="off">
                    @csrf
                    <div>
                    ...
                    @enderror
										<div class="flex items-center justify-end w-full">
											<span>Нет аккаунта ? <a href="{{ route('register.index') }}" class="text-[#8a70d6]">Создайте!</a></span>
										</div>
                    <button type="submit"
