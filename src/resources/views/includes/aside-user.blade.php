                ...
                <li>
                    <a href="{{ route('course.personal.index') }}"
                       class="flex items-center px-2 py-2 group hover:bg-[#e9e3ff] transition rounded-md {{ Route::is('course.personal.index') ? 'bg-[#e9e3ff]' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor"
                             class="w-6 h-6 mr-2 group-hover:stroke-violet-icon group-hover:stroke-[2px] transition {{ Route::is('course.personal.index') ? 'stroke-[2px]' : '' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5"/>
                        </svg>


                        <span class="mr-auto group-hover:font-bold text-sm {{ Route::is('course.personal.index') ? 'font-bold text-sm' : '' }}">Мои курсы</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" data-slot="icon"
                             class="w-6 h-6 group-hover:stroke-violet-icon group-hover:stroke-[2px] transition {{ Route::is('course.personal.index') ? 'stroke-[2px]' : '' }}">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5">
                            </path>
                        </svg>
                    </a>
                ...
                <li>
                    <a href="{{ route('main.admin.index') }}"
                       class="flex items-center px-2 py-2 group hover:bg-[#e9e3ff] transition rounded-md {{ Route::is('main.admin.index') ? 'bg-[#e9e3ff]' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor"
                             class="w-6 h-6 mr-2 group-hover:stroke-violet-icon group-hover:stroke-[2px] transition {{ Route::is('main.admin.index') ? 'stroke-[2px]' : '' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <span class="mr-auto group-hover:font-bold text-sm {{ Route::is('main.admin.index') ? 'font-bold text-sm' : '' }}">Администрирование</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" data-slot="icon"
                             class="w-6 h-6 group-hover:stroke-violet-icon group-hover:stroke-[2px] transition {{ Route::is('main.admin.index') ? 'stroke-[2px]' : '' }}">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5">
                            </path>
                        </svg>
                    </a>
